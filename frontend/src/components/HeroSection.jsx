...
const HeroSection = () => {
    return (
        <div className="relative rounded-3xl overflow-hidden shadow-lg bg-gradient-to-r from-purple-600 to-indigo-600 text-white mb-8 group">
            ...
            <div className="relative p-8 md:p-12 z-10 flex flex-col items-start justify-center min-h-[220px]">
                <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-medium mb-4 border border-white/30">
                    Admin Dashboard
                </span>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">Welcome to Daycare<br />Admin Dashboard</h2>
                ...
                <button className="mt-6 px-6 py-3 bg-white text-purple-700 rounded-xl font-semibold hover:bg-purple-50 transition-all shadow-md active:scale-95">
                    Get Started
                </button>
            </div>
        </div>
