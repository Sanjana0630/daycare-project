        ...
        <div className="relative">
            ...
            {type === 'select' ? (
                <select
                    ...
                    value={value}
                    onChange={onChange}
                    className={`w-full ${Icon ? 'pl-10' : 'pl-4'} pr-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-400 transition-all outline-none appearance-none`}
                >
...
const AddStaff = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('Attempting to save staff to:', `${apiUrl}/api/staff`);
        ...
        <div className="max-w-4xl mx-auto pb-12 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-gray-500">Register a new educator or staff member.</p>
                </div>
